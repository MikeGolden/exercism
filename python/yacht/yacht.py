...
# The 'score' function takes a list of dice and a scoring category function,
# sorts the dice, and then applies the scoring category function to calculate the score.
